...
(function () {
  var groups = [
    { id: 'new', label: 'NEW', en: 'NEW PROMPTS', description: '新しく追加されたプロンプト', titles: ['うちの子スマブラ参戦', '墨絵+露光', 'うちの子ドーナツ診断'] },
    ...
    { id: 'game', label: 'ゲーム系プロンプト', en: 'GAME', description: 'ゲームにまつわるプロンプト', titles: ['うちの子スマブラ参戦', 'ポケカ風TCG化', 'うちの子ピクミン', 'アモアス役職診断'] },
